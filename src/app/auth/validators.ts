...
export function matchPasswordValidator(control: any, Form: FormGroup, variable: String) {

  const password = Form?.get(`${variable}`)?.value;
  const confirmPassword = control.value;

  console.log(password, "pass");
  console.log(confirmPassword, "confirm pass");
